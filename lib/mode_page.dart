...
class ModePage extends StatefulWidget {
  static String tag = 'mode-page';
  @override
  _ModePageState createState() => new _ModePageState();
}
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                FancyButton(
                  child: Container(
                    margin: EdgeInsets.fromLTRB(80, 15, 80, 15),
                    child: Text(
                      "Piala Dunia",
                      textAlign: TextAlign.center,
                      style: TextStyle(
                ...
                FancyButton(
                  child: Container(
                    margin: EdgeInsets.fromLTRB(75, 15, 75, 15),
                    child: Text(
                      "Main Sendiri",
                      textAlign: TextAlign.center,
                      style: TextStyle(
                ...
                FancyButton(
                  child: Container(
                    margin: EdgeInsets.fromLTRB(63, 15, 63, 15),
                    child: Text(
                      "Main Bersama",
                      textAlign: TextAlign.center,
                      style: TextStyle(
